...
function cekUrl(current_url, nomor=1){
	...
	setTimeout(function(){
		...
		if(title_admin.length >= 1){
								...
								+'<div class="modal-content">'
									...
									+'<div class="modal-body">'
										+'<div class="no_datatable">'
											+'<table class="table table-striped" id="table_sub_keg_modal_sumber_dana_rekap">'
												+'<thead>'
												...
												+'<tfoot>'
													...
													+'</tr>'
													+'<tr id="rekap_pemutakhiran_akun">'
														+'<td colspan="3"></td>'
													+'</tr>'
													+'<tr id="rekap_pemutakhiran_ssh">'
														+'<td colspan="3"></td>'
													+'</tr>'
												+'</tfoot>'
											+'</table>'
			...
			else if(current_url.indexOf('/laporan/rekap') != -1)
			{
				console.log('halaman laporan/rekap');
				jQuery('.aksi-extension').remove();
				var btn = ''
					+'<div class="aksi-extension">'						
